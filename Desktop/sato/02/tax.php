  ...
  <body>
    <h1>税率計算</h1>
      ...
      <table  border="1" style="border-collapse:collapse;">
          ...
          <tr>
              <td><?php echo $name01;?></td>
              <td style="text-align: right;"><?php echo number_format($price01);?></td>
              <td><?php echo $number01;?></td>
              <td><?php echo $tax01;?>%</td>
              <td><?php echo number_format($sum01);?></td>
          </tr>
          <tr>
              <td><?php echo $name02;?></td>
              <td style="text-align: right;"><?php echo number_format($price02);?></td>
              <td><?php echo $number02;?></td>
              <td><?php echo $tax02;?>%</td>
              <td><?php echo number_format($sum02);?></td>
          </tr>
          <tr>
              <td><?php echo $name03;?></td>
              <td style="text-align: right;"><?php echo number_format($price03);?></td>
              <td><?php echo $number03;?></td>
              <td><?php echo $tax03;?>%</td>
              <td><?php echo number_format($sum03)?></td>
          </tr>
          <tr>
              <td><?php echo $name04;?></td>
              <td style="text-align: right;"><?php echo number_format($price04);?></td>
              <td><?php echo $number04;?></td>
              <td><?php echo $tax04;?>%</td>
              <td><?php echo number_format($sum04);?></td>
          </tr>
          <tr>
              <td><?php echo $name05;?></td>
              <td style="text-align: right;"><?php echo number_format($price05);?></td>
              <td><?php echo $number05;?></td>
              <td><?php echo $tax05;?>%</td>
              <td><?php echo number_format($sum05);?></td>
          </tr>
          <tr>
              <td colspan="4">合計</td>
